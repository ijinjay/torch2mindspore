...
@mindspore_converter('torch.nn.functional.leaky_relu')
@mindspore_converter('torch.nn.functional.leaky_relu_')
def convert_leaky_relu(ctx):
    ...
    ms_cell = ms.nn.LeakyReLU(alpha = negative_slope)
...
# @mindspore_converter('torch.nn.functional.elu')
# @mindspore_converter('torch.nn.functional.elu_')
# def convert_elu(ctx):
#     input = get_arg(ctx, 'input', pos=0, default=None)
...
# @mindspore_converter('torch.selu')
# @mindspore_converter('torch.selu_')
# @mindspore_converter('torch.nn.functional.selu')
# @mindspore_converter('torch.nn.functional.selu_')
...
# @mindspore_converter('torch.nn.functional.softsign')
# def convert_softsign(ctx):
#     __convert_unary(ctx, ms.ops.Softsign)
...
# @mindspore_converter('torch.nn.functional.softplus')
